        ...
        <div className="flex-1 overflow-y-auto">
          ...
          >
            ...
            <p className="text-gray-600 text-center mb-8 leading-relaxed">
              Calendar integration has been disabled. You can still use the app to track your wellness activities manually.
            </p>
            ...
            <div className="mt-8 bg-blue-50 rounded-2xl p-4 w-full max-w-sm">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Manually schedule wellness activities</li>
